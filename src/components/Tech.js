        ...
        <h1 className="claim-grid__header">
          ...
          <span className="button__content">
            <span className="icon__wrapper icon__wrapper--Speaker">
              <svg size="20" className="icon icon--Speaker claim-grid__header-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="-5 0 24 24" width="20" height="20" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
