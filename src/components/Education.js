  ...
  return (
      <>
        ...
        <h1 className="claim-grid__header">
          <Link className="button button--link" to="/education">
          <span class="button__content">
            <span class="icon__wrapper icon__wrapper--Education">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon--Education claim-grid__header-icon" aria-hidden="true">
                  <g>
            ...
            <span class="claim-grid__title">Education</span>
          </span>
          </Link>
        </h1>
