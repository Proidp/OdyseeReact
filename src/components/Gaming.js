  ...
  return (
      ...
      <div className="claim-grid__wrapper">
        <h1 className="claim-grid__header">
          <Link className="button button--link" to="/gaming">
          <span classNane="button__content">
            <span classNane="icon__wrapper icon__wrapper--Gaming">
              <svg size="20" classNane="icon icon--Gaming claim-grid__header-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -1 24 26" width="20" height="20" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <g>
            ...
            <span classNane="claim-grid__title">Gaming</span>
          </span>
          </Link>
        </h1>
            ...
            <div>
                ...
                <Link className="button button--no-style" aria-hidden="true" tabindex="-1" to="/profile">
                    ...
                    <div className="channel-thumbnail channel-thumbnail--xsmall">
                        <img alt="Channel profile picture" className="channel-thumbnail__custom" loading="lazy" src="https://spee.ch/0/c9e781fef6deb7c9.jpg?quality=85&amp;height=100&amp;width=0" style={{visibility: "visible"}}/>
