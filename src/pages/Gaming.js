         ...
         <div className={switchToggled ? "sidebar--pusher" : "sidebar--pusher sidebar--pusher--open"}>
            <main id='main-content' className='main main--full-width'>
                <label className="claim-list__header-label">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon--Artists" aria-hidden="true">
                        <g>
                            <path d="M10.107,16.884,22.372,4.657a2.5,2.5,0,0,0-3.744-3.314L7.954,15.04"></path>
                ...
                <div>
                    ...
                    <section className='claim-grid'>
                        ...
                        <li className="card claim-preview--tile">
                            <Link role="none" tabindex="-1" aria-hidden="true" to="/playvideo">
                            ...
                            <div>
                                ...
                                <Link className="button button--no-style" aria-hidden="true" tabindex="-1" to="/profile">
                                    <span className="button__content">
                                    <div className="channel-thumbnail channel-thumbnail--xsmall">
                                        <img alt="Channel profile picture" className="channel-thumbnail__custom" loading="lazy" src="https://thumbnails.odycdn.com/optimize/s:0:100/quality:85/plain/https://thumbnails.lbry.com/UC_9PkaJHT25LwQ6HLydPavQ" style={{visibility: "visible"}}/>
                                        <div className="channel-staked__wrapper">
                                        <svg size="14" className="icon icon--ChannelLevel5 channel-staked__indicator channel-staked__indicator--controlling" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="currentColor" stroke="currentColor" stroke-width="0" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <div className="claim-tile__about">
                                    <Link className="button button--no-style button--uri-indicator" aria-hidden="false" tabindex="0" to="/profile">
                                    <span className="button__content">
