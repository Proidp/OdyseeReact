      ...
      <header className="header header--minimal">
        <div className="header__navigation">
            ...
            <Link className="button button--no-style header__navigationItem--logo" title="Home" aria-label="Home" to="/">
                <span className="button__content">
                <svg size="16" className="icon icon--OdyseeLogoDarkText header__logo" aria-hidden="true" data-name="Layer 1" id="Layer_1" stroke-width="0" viewBox="0 0 397 119.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
            ...
            <Link title="Go Back" aria-label="Go Back" className="button button--alt" type="button" to='/'>
                <span className="button__content">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon--X" aria-hidden="true">
                    <g>
                  ...
                  <div>
                    <form novalidate="" className="section">
                      ...
                      <div className="section__actions">
                        ...
                        <button aria-label="Sign Up" className="button button--link" type="button">
                          <span className="button__content">
